...
$result3 = $objExamen->listar($txt_id_gru);
$item = 0;
...
<td id='td_fecha_exam_$item'>$examen->fecha_exam</td>
   ...
   <td id='td_tlimite_exam_$item'>$examen->tlimite_exam</td>
    ...
    <td>
        <a id='btnPublicar' href='./procesar/pPublicar.php?id=$examen->id_exam&id_gr=$txt_id_gru'>Publicar</a><span> / </span>
        <a id='btnActMat' data-toggle='tab' href='vistas#reg_exam' onclick='enviarExamen($item)'>Actualizar</a><span> / </span>
       ";?>
    <a  href='./procesar/pExamen.php?op=1&key2=<?php echo $examen->id_exam?>&id_gr=<?php echo $txt_id_gru?>' onclick='return confirmarEliminar("Material");'>Eliminar</a>
    <?php echo "</td>
</tr>";
}?>
