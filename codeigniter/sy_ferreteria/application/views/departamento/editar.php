...
<section class="col-md-9">
	...
	<div class="col-md-6 col-md-offset-3">
		...
		<div class="panel-heading">
			<?php echo heading('EDITAR DEPARTAMENTO', 2, array('class' => 'panel-title'));?>
		</div>
		<div class="panel-body">
			<?php echo form_open(base_url().'departamento/editar/'.$data_departamento->id)?>
			<?php
			$input_departamento = array(
				'type'			=>'text',
		        'name'          => 'input_departamento',
		        'class'			=>'form-control',
		        'value'         => set_value('input_departamento',$data_departamento->nombre),
		        'maxlength'     => '100',
		        'size'          => '50',
			...
			<div class="form-group">	
				...
				$data_radio=array(
					...
					'id'=>'radio_estado',
					'value'=>1,
					'checked'   => (set_value('radio_estado',$data_departamento->estado) === '0' ? TRUE : FALSE)
					);
