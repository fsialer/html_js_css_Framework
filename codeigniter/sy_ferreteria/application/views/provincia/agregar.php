...
<section class="col-md-9">
	...
	<div class="col-md-6 col-md-offset-3">
		...
		<div class="panel-heading">
			<?php echo heading('REGISTRO PROVINCIA', 2, array('class' => 'panel-title'));?>
		</div>
		<div class="panel-body">
			<?php echo form_open(base_url().'provincia/agregar')?>
			<?php
			$input_provincia = array(
				'type'			=>'text',
		        'name'          => 'input_provincia',
		        'class'			=>'form-control',
		        'value'         => set_value('input_provincia'),
		        'maxlength'     => '100',
		        'size'          => '50',
			...
			<div class="form-group">
				...
				<?php echo form_dropdown('cboDepartamento',$data_departamento,set_value('cboDepartamento'),array('class'=>'form-control'));?>	
