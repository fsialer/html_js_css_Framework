...
<section class="col-md-9">
	...
	<li class="active">MANTENIMIENTO</li>
	  <li><a href="<?php echo base_url().'distrito'?>">DISTRITO</a></li>
	  <li class="active">AGREGAR</li>
	</ol>
	<div class="col-md-6 col-md-offset-3">
		<div class="panel panel-success ">
			<div class="panel-heading">
			<?php echo heading('REGISTRO DISTRITO', 2, array('class' => 'panel-title'));?>
			</div>
			<div class="panel-body">
				<?php echo form_open(base_url().'distrito/agregar')?>
				<?php
			...
			<div class="form-group">
				...
				<?php echo form_dropdown('cboDepartamento',$data_departamento,set_value('cboDepartamento'),array('class'=>'form-control','id'=>'cboDepartamento'));?>	
