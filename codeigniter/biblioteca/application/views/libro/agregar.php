	...
	<div class="col-md-9 col-md-offset-1">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<?php echo form_open(base_url().'libro/agregar');?>
				<div>
					...
					<div class="form-group col-md-6">
						...
						<?php echo form_input(array('name'=>'input_nom','class'=>'form-control','placeholder'=>'LIBRO','value'=>set_value('input_nom')))?>	
				...
				<div>
					<div class="form-group col-md-6">
						...
						<?php echo form_dropdown('cboAutor',$data_autores,set_value('cboAutor'),array('id'=>'cboAutor','class'=>'form-control'));?>
						<?php echo form_error('cboAutor', '<div class="">', '</div>'); ?>
					</div>
					<div class="form-group col-md-6">
						<?php echo form_label("EDITORIAL")?>
						<?php echo form_dropdown('cboEditorial',$data_editoriales,set_value('cboEditorial'),array('id'=>'cboEditorial','class'=>'form-control'));?>
				...
				<div>
					<div class="form-group col-md-6">
						...
						<?php echo form_input(array('name'=>'input_nump','class'=>'form-control','placeholder'=>'NUMERO DE PAGINAS','value'=>set_value('input_nump'),'type'=>'number'))?>
						<?php echo form_error('input_nump', '<div class="">', '</div>'); ?>
					</div>	
				
					<div class="form-group col-md-6">
						<?php echo form_label('STOCK');?>
						<?php echo form_input(array('name'=>'input_stock','class'=>'form-control','placeholder'=>'STOCK','value'=>set_value('input_stock'),'type'=>'number'))?>
				...
				<div>
					<div class="form-group col-md-6">
						...
						<?php echo form_input(array('name'=>'input_fp','class'=>'form-control','value'=>set_value('input_fp'),'type'=>'date'))?>
						<?php echo form_error('input_fp', '<div class="">', '</div>'); ?>
					</div>	
					<div class="form-group col-md-6">
						<?php echo form_label('UBICACION');?>
						<?php echo form_input(array('name'=>'input_ubi','class'=>'form-control','placeholder'=>'UBICACION','value'=>set_value('input_ubi')))?>	
