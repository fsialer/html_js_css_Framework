...
<section class="col-md-10">	
	<div>
		<a href="<?php echo base_url().'editorial/agregar'?>" class="btn btn-primary">AGREGAR <i class="glyphicon glyphicon-plus"></i></a>
	</div>
	<div>
	...
	<div class="panel panel-info">
		<div  class="panel-heading">
			<span>LISTADO DE EDITORIALES</span>
		</div>
		<div class="panel-body table-responsive">
			<table class="table table-striped">
				...
				<?php
			foreach ($data_editoriales as $editoriales) {?>
			<tr>
				<td><?php echo $editoriales->nombre;?></td>													
				<td><a href="<?php echo base_url().'editorial/editar/'.$editoriales->id;?>"><i class="glyphicon glyphicon-pencil alert-warning"></i></a>
				<a href="<?php echo base_url().'editorial/borrar/'.$editoriales->id;?>"><i class="glyphicon glyphicon-remove alert-danger"></i></a></td>
