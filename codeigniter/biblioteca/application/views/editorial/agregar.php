	...
	<div class="col-md-5 col-md-offset-3">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<?php echo form_open(base_url().'editorial/agregar');?>
				<div class="form-group">
					<?php echo form_label('NOMBRE');?>
					<?php echo form_input(array('name'=>'input_nom','class'=>'form-control','placeholder'=>'EDITORIAL','value'=>set_value('input_nom')))?>	
