	...
	<div class="col-md-5 col-md-offset-3">
		<div class="panel panel-warning">
			<div class="panel-heading">
				<span>EDITAR TEMATICA</span>
			</div>
			<div class="panel-body">
				<?php echo form_open(base_url().'tematica/editar/'.$data_tematicas->id);?>
				<div class="form-group">
					<?php echo form_label('NOMBRE');?>
					<?php echo form_input(array('name'=>'input_nom','class'=>'form-control','placeholder'=>'NOMBRE','value'=>set_value('input_nom',$data_tematicas->nombre)))?>	
					<?php echo form_error('input_nom', '<div class="">', '</div>'); ?>
				</div>
				<div class="form-group">
					<?php echo form_label('ABREVIATURA');?>
					<?php echo form_input(array('name'=>'input_abrev','class'=>'form-control','placeholder'=>'ABREVIATURA','value'=>set_value('input_abrev',$data_tematicas->abreviatura)))?>
