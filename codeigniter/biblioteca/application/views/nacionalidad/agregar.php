	...
	<div class="col-md-5 col-md-offset-3">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<?php echo form_open(base_url().'nacionalidad/agregar');?>
				<div class="form-group">
					<?php echo form_label('PAIS');?>
					<?php echo form_input(array('name'=>'input_pais','class'=>'form-control','placeholder'=>'NOMBRE','value'=>set_value('input_pais')))?>	
					<?php echo form_error('input_pais', '<div class="">', '</div>'); ?>
				</div>
				<div class="form-group">
					<?php echo form_label('NACIONALIDAD');?>
					<?php echo form_input(array('name'=>'input_nom','class'=>'form-control','placeholder'=>'NACIONALIDAD','value'=>set_value('input_nom')))?>
