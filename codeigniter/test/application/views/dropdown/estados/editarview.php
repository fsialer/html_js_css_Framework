...
<html>
<head>
	<title>EDITAR UN DISTRITO</title>
...
<body>
	<header id="content-header">
		<h1>EDITAR UN DISTRITO</h1>
	</header>
	<div id="content-body">
		<?php echo form_open(base_url().'dropdownestados/editar/'.$data_estados->estados_id);?>
		<div>
			<?php echo form_label("REGION")?>
			<?php echo form_dropdown('cboRegion',$data_regiones,set_value('cboRegion',$data_estados->id_region),array('id'=>'cboRegion'));?>
		...
		<div>
			...
			'value'=>set_value('input_distrito',$data_estados->distrito)));?>
		...
		<div>
			...
			<?php echo form_radio(array('name'        => 'estado',
							'id'          => 'estado',
							'value'       => 'INACTIVO',
							'checked'     => (set_value('estado',$data_estados->estado) === 'INACTIVO' ? TRUE : FALSE)))?>INACTIVO
			<?php echo form_radio(array('name'        => 'estado',
							'id'          => 'estado1',
							'value'       => 'ACTIVO',
							'checked'     => (set_value('estado',$data_estados->estado) === 'ACTIVO' ? TRUE : FALSE)))?>ACTIVO
			<div id="error"><?php echo form_error('estado')?></div>
		</div>

		<?php echo form_submit('btnGuadar','EDITAR')?>
		<?php echo form_close();?>
